...
import { View, Text, Button, StyleSheet, FlatList, TouchableOpacity, TextInput, SafeAreaView } from 'react-native';
...
export const OrderPageByCart = ({navigation, route}) => {
    ...
    const handleOrder = () => {
      ...
      axios.post(`${API_URL}/api/orders/cart`, body, {headers: {Authorization: `Bearer ${accessToken}`}})
      .then((response) => {
    ...
    return (
        ...
        <FlatList 
          ...
          <TouchableOpacity style={[styles.editButton, styles.rightAlign]} onPress={() => navigation.navigate('EditDeliveryInfoPage', {...route.params, deliveryInfo: deliveryInfo, page: 'OrderPageByCart'})}>
            <Text style={styles.editButtonText}>수정</Text>
          </TouchableOpacity>
          
          <FlatList
            data={items}
            renderItem={renderItemByCart}
